---
title: The tired self as I know it 
...
However, I do not want to get lost in its depth. I know how deep it can be, I know it does not exist in this realm. I also know it is not what I think it is. A lot of questions, but very few answers. But asking the right questions are more important than the answers. The answers can be subjective, but questions, as far as I am concerned, are thought objects, a frozen stream of thought taking its shape as a question, only comprehensive to our immediate self.
...
Nothing is absolute when it comes to thoughts, feelings and emotions, but actions can be absolute, and actions influence my behaviour, that is, the thoughts that triggered the actions in the first place.
